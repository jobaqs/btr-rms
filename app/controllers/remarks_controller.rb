class RemarksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @remark.save
        format.html { redirect_to document_path(@remark.document_id), notice: 'Remark was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to document_url(@remark.document_id) }
      format.json { head :no_content }
    end
  end
end
